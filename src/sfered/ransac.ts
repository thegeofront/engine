...
export function RansacEliplse2d(
    points: Vector2Array, iterations: number, radius: number, elipseDeviation: number, tolerance: number,
    seed: number, minScore: number, maxRadiusDeviation: number) : [Circle2, number[]] | undefined {
    //  Extract circle parameters from points in 2D space.
